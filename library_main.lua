...
local function patchMacLibSource(macSource)
	...
	macSource = macSource:gsub("ghostLogo%.Position = UDim2%.new%(0, 4, 1, %-12%)", "ghostLogo.Position = UDim2.new(0, -18, 0, -14)")
...
local function tuneMacSidebarLayout(gui)
	...
	if ghostLogo and informationHolder then
		...
		ghostLogo.Position = UDim2.new(0, -18, 0, -14)
